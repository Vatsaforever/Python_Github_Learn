...
Books = [{'Title':'Lord of the Rings','Author':'JRR Tolkien','Year':'1947'},
         {'Title':'Harry Potter','Author':'JK Rowling','Year':'1991'},
         {'Title':'The Song of Ice and Fire','Author':'GRR Martin','Year':'1988'}]
print(Books[1]['Title'])
print(Books[2]['Year'])
for Book in Books:
